...
import 'screens/gs1_config_screen.dart';
        ...
        onGenerateRoute: (settings) {
          switch (settings.name) {
            ...
            case '/scanner-action':
              ...
              return MaterialPageRoute(builder: (_) => ScannerActionScreen(type: args['type'], id: args['id']));
            case '/product':
              final productId = settings.arguments as String;
              return MaterialPageRoute(builder: (_) => ProductDetailScreen(productId: productId));
            case '/gs1-config':
              return MaterialPageRoute(builder: (_) => const GS1ConfigScreen());
            default:
              return MaterialPageRoute(builder: (_) => const MainNavigation());
          }
        },
