...
- nfc_foreground_dispatch.dart
- nfc_route_guard.dart
- mobile-mcp
...
Cohesion: 0.17
Nodes (14): wchar_t, Scale(), Create, Destroy, GetHandle, SetQuitOnClose, Show, Win32Window::Win32Window() (+6 more)
...
Cohesion: 0.05
Nodes (41): bool get, FieldSize, ScanMode, static const LayoutConfig, String get, baseUrl, copyWith, domain (+33 more)
...
Cohesion: 0.06
Nodes (35): StepType, AutomationStep, AutomationStepConfig, color, config, copyWith, createdAt, CustomAutomation (+27 more)
...
Cohesion: 0.07
Nodes (29): AudioPlayer, package:audioplayers/audioplayers.dart, static bool, static final AudioPlayer, dispose, enableAutomationSoundsOnly, playAlarm, playAnomaly (+21 more)

### Community 27 - "timeline_event.dart"
Cohesion: 0.10
Nodes (20): changes, details, field, finalPrice, from, fromJson, id, newValue (+12 more)

### Community 28 - "Dettaglio Schermate — Syncro Flow (Audit minimo per ogni componente)"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (25): MobileScannerState, package:image_picker/image_picker.dart, package:permission_handler/permission_handler.dart, scanner_action_screen.dart, ../services/barcode_decoder_service.dart, ../services/nfc_foreground_dispatch.dart, build, _cameraErrorMsg (+17 more)
...
Cohesion: 0.11
Nodes (17): app_links, audioplayers_darwin, battery_plus, connectivity_plus, file_picker_darwin, file_selector_macos, flutter_secure_storage_darwin, Foundation (+9 more)

### Community 41 - "nfc_tools_screen.dart"
Cohesion: 0.11
...
Cohesion: 0.13
Nodes (14): package:flutter/foundation.dart, package:http/http.dart, BarcodeDecodeResult, BarcodeDecoderService, data, decodeBytes, decodeImage, error (+6 more)
...
### Community 52 - "4. Piano a Fasi"
Cohesion: 0.12
Nodes (15): 1. Contesto e Stato Attuale (verificato), 2. Matrice Sostituzioni (ricerca approfondita, alternative community mantenute), 3. Architettura Target, 4. Piano a Fasi, 5. Rischi & Mitigazioni, 6. Verifica & Criteri Accettazione, 7. Salvataggio su Grafo, Fase 0 — Baseline & Branch (0.5g) (+7 more)
...
Cohesion: 0.31
Nodes (4): MainActivity, Bundle, ReactActivity, ReactActivityDelegate

### Community 61 - "dynamic_field_renderer.dart"
Cohesion: 0.05
Nodes (40): app_image.dart, ../core/constants/config.dart, Set, build, _controller, createState, _darkInputDecoration, display (+32 more)

### Community 62 - "Win32Window"
Cohesion: 0.18
...
### Community 66 - "app_image.dart"
Cohesion: 0.18
Nodes (10): BoxFit, double?, file_image_helper.dart, AppImage, build, _defaultFallback, fit, height (+2 more)
...
Cohesion: 0.27
Nodes (6): SaveFormat, BarcodeDecodeResult, createImageVariations(), decodeBarcodeImage(), tryQRServer(), tryZXing()

### Community 79 - "StatelessWidget"
Cohesion: 0.17
Nodes (12): StatelessWidget, _TimelineEventTile, _ChoiceChips, _DateField, _DocumentField, DynamicFieldRenderer, _ImagesField, _ModalPickerField (+4 more)
...
Cohesion: 0.17
Nodes (9): package:flutter_test/flutter_test.dart, package:syncro_flow/core/theme/app_colors.dart, package:syncro_flow/core/utils/nfc_route_guard.dart, package:syncro_flow/models/location.dart, package:syncro_flow/models/product.dart, package:syncro_flow/services/nfc_coordinator.dart, main, main (+1 more)
...
Cohesion: 0.33
Nodes (5): FlutterActivity, FlutterEngine, NfcAdapter, PendingIntent, MainActivity

### Community 99 - "home_scanner_button_test.dart"
Cohesion: 0.15
...
Cohesion: 0.07
Nodes (29): nfc_foreground_dispatch.dart, static bool get, static const Duration, static DateTime?, static DateTime? get, static NfcMode?, static NfcMode? get, static String? (+21 more)
...
### Community 139 - "expo-print"
Cohesion: 0.50
Nodes (3): expo-print, expo-print, printToFileAsync()

### Community 140 - "patch_fase3.js"
Cohesion: 0.40
...
Cohesion: 0.20
Nodes (9): 1. Modelli, 2. Store & Persistenza, 3. UI Entry, 4. Esecuzione, 5. QR Trigger, 6. Settore-agnostico — esempi, 7. Cosa non deve cambiare (vincolo), Automazioni — Engine Completo (per qualsiasi settore) (+1 more)

### Community 221 - "Checklist Parità — Verifica post-eject (da spuntare)"
Cohesion: 0.20
Nodes (9): Automazioni, Build & Tooling, Checklist Parità — Verifica post-eject (da spuntare), Inventario & Logistica, Media & File, Nativo, Navigazione (Fase 2), Services (+1 more)

### Community 222 - "Logistica & Inventario — Flussi Funzionali Completi"
Cohesion: 0.20
Nodes (9): 1. Modelli Dati (da `types/index.ts`), 2. Inventario Core (da `InventoryContext.tsx:21`), 3. Logistica (Posizioni, Cartelle, Layout), 4. Scanner & Acquisizione (da `app/scanner.tsx:5`, `components/BarcodeScanner.tsx:3`, `utils/barcodeDecoder.ts:6`), 5. Prodotto Detail & Edit (da `app/product/[id].tsx:5`, `app/product/edit/[id].tsx:6`), 6. Export & Share (da `app/(tabs)/settings.tsx:7`), 7. Settore-agnostico — come adattarsi, Checklist parità (usare `CHECKLIST_PARITA.md`) (+1 more)

### Community 223 - "Design System — La Palais (vincolo visivo post-eject)"
Cohesion: 0.25
...
Cohesion: 0.40
Nodes (4): File, path, readAsBytes, readAsBytesSync

### Community 231 - "2. Gap di `syncro_flow_flutter/` (migrazione reale)"
Cohesion: 0.15
Nodes (12): 1.1 Diagnosi `flutter_app/` (quella testata sul telefono) — "involucro" confermato, 1. Causa radice: ESISTONO DUE PROGETTI FLUTTER, 2.1 Bloccanti (l'app appare "vuota"), 2.2 Renderer campi dinamici (causa "campi non modificabili"), 2.3 Aggiungi prodotto (`add_product_screen.dart`), 2.4 Home (`home_screen.dart`), 2.5 Automazioni — esecuzione non reale, 2.6 Impostazioni ridotte (vs RN) (+4 more)

### Community 233 - "Piano strutturato 5 fasi"
Cohesion: 0.18
Nodes (10): Contesto, Fase A — NFC Coordinator a priorità (fix 3,5, cooldown), Fase B — Lancio esterno (fix 1), Fase C — Fotocamera/flash (fix 2), Fase D — Suoni multifrequenza (fix 4), Fase E — UI + black screen guard (fix 5,6), Implementation Plan V2 — SyncroFlow Flutter (2026-08-29), Piano strutturato 5 fasi (+2 more)

### Community 234 - "Piano di Implementazione — Colmare il gap Flutter ↔ React Native"
Cohesion: 0.20
Nodes (9): Fase G0 — Sblocco immediato (quick wins) [~0.5 gg], Fase G1 — Modifica prodotto + renderer campi completi [~2-3 gg], Fase G2 — Aggiungi prodotto completo [~1-2 gg], Fase G3 — Impostazioni a parità [~2-3 gg], Fase G4 — Automazioni davvero eseguibili [~3-4 gg] (priorità alta: "le automazioni non funzionano"), Fase G5 — Servizi mancanti [~1 gg], Fase G6 — QA finale e consegna [~1 gg], Note operative (+1 more)

### Community 235 - "Audit Applicazione Syncro Flow — Parità pre-eject Expo"
Cohesion: 0.29
Nodes (6): Audit Applicazione Syncro Flow — Parità pre-eject Expo, Come rigenerare gli screenshot quando hai un device, Come è stato catturato, Handoff implementazione, Struttura cartella, Vincolo visivo La Palais

### Community 237 - "nfc_foreground_dispatch.dart"
Cohesion: 0.29
Nodes (6): package:flutter/services.dart, static const, _channel, disable, enable, NfcForegroundDispatch

### Community 238 - "nfc_route_guard.dart"
Cohesion: 0.33
Nodes (5): return, extractSkuCandidate, isNfcSuppressedRoute, skuCandidate, startsWith

### Community 239 - "mobile-mcp"
Cohesion: 0.17
Nodes (11): mcp, mobile-mcp, command, enabled, type, plugin, $schema, @mobilenext/mobile-mcp@latest (+3 more)

### Community 240 - "Screenshot — Placeholder (device non connesso al momento audit)"
Cohesion: 0.40
Nodes (4): Come generarli (quando hai device), Fallback web (senza device), Lista screenshot attesi (da generare), Screenshot — Placeholder (device non connesso al momento audit)

### Community 241 - "Permissions Audit — Pre-eject vs Post-eject"
Cohesion: 0.50
Nodes (3): Permissions Audit — Pre-eject vs Post-eject, Post-eject target (5-7 permessi), Pre-eject (Expo managed — 22 permessi)

### Community 266 - "OnCreate"
Cohesion: 0.25
Nodes (7): PluginRegistry, RECT, RegisterPlugins(), OnCreate, GetClientArea, OnCreate, SetChildContent

### Community 267 - "MessageHandler"
Cohesion: 0.22
...
Cohesion: 0.40
Nodes (6): State, StatefulWidget, BarcodeScannerView, _BarcodeScannerViewState, _InlineBarcodeScanner, _InlineBarcodeScannerState

### Community 272 - "copy_screens.js"
Cohesion: 0.40
